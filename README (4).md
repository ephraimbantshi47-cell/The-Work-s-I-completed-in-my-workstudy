...
| Tool | What it does |
|---|---|
| **[Cognos Report Parser](01_cognos_report_parser/)** | Recursively parses Cognos XML report files and generates a single searchable HTML dashboard of every query, field, filter, and join operation |
